    ...
    public void convert(View view) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Double poundAmount = dollarAmount/22.1;
                AlertDialog.Builder dig1 = new AlertDialog.Builder(SGD.this);
                dig1.setTitle("THAI --> SGD");
                dig1.setMessage(" "+poundAmount+"ดอลลาร์สิงคโปร์" );
