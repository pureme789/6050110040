...
public class CNY extends AppCompatActivity {
    ...
    public void convert(View view) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Double poundAmount = dollarAmount/4.2;
                AlertDialog.Builder dig1 = new AlertDialog.Builder(CNY.this);
                dig1.setTitle("THAI --> CNY");
                dig1.setMessage(" "+poundAmount+"หยวน" );
