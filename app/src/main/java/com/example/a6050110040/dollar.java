    ...
    public void convert(View view) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Double poundAmount = dollarAmount/30.5;
                AlertDialog.Builder dig1 = new AlertDialog.Builder(dollar.this);
                dig1.setTitle("THAI --> USA");
                dig1.setMessage(" "+poundAmount+"ดอลลาร์สหรัฐอเมริกา" );
